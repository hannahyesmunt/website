...
export default function CaseStudiesPage() {
  const caseStudies = getProjectsByCategory("case-studies").sort(
    (a, b) => caseStudyOrder.indexOf(a.slug) - caseStudyOrder.indexOf(b.slug)
  );
        ...
        <header className="mb-8 md:mb-12">
          ...
          <div className="max-w-2xl">
            <p className="text-xs md:text-base text-muted leading-relaxed">
              Selected projects with full process documentation — from brand-scale product
              development to independent design and construction.
            </p>
          </div>
        </header>
